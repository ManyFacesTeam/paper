...
(results_trait_std$plot + ggtitle("Standardized trait ratings")) /
  (results_trait_unstd$plot + ggtitle("Unstandardized trait ratings")) /
  (results_emo_int$plot + ggtitle("Emotion intensity")) +
...
#| tbl-cap: Cronbach’s alpha and McDonald’s omega total for for trait and emotion intensity ratings
